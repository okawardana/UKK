...
<?php $this->load->view('Admin/_partials/navbar.php');?>
    ...
    <div class="container-fluid">
        <form class="row g-3" action="<?= base_url('Admin/tfkamar');?>" method="POST">
        <input type="hidden" class="form-control" id="inputPassword4" name="id_fkamar" >
        <div class="col-md-4">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="inputPassword4" name="nama_fasilitas" >
        </div>
        <div class="col-12">
            <label for="inputAddress" class="form-label">Kategori</label>
            <input type="text" class="form-control" id="inputAddress" name="kategory" >
        </div>
        <div class="col-12">
