        ...
        <div class="float-end show" id="navbarColor01" style="margin-right:40px;">
          <ul class="navbar-nav mr-auto">
            <?php if (!empty($_SESSION['login']->level)) :?>
              ...
              <li>
              <a class="nav-link" href="<?= base_url('Admin/kamar');?>">Kamar</a>
              </li>
              <li>
              <a class="nav-link" href="<?= base_url('Admin/Faskamar');?>">Fasilitas Kamar</a>
              </li>
              <li>
              <a class="nav-link" href="<?= base_url('Admin/Fashotel');?>">Fasilitas Hotel</a>
              </li>
