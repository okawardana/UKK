...
<?php $this->load->view('Admin/_partials/navbar.php');?>
      ...
      <div class="container-fluid">
          <table class="table table-striped mt-2 mb-4" id="myTable">
                  ...
                  <tbody>
                      <?php foreach ($Fh as $value) :?>
                      <tr>
                      <td width="200"><?= $value->nama_fasilitas?></td>
                      <td width="200"><?= $value->img?></td>
                      <td width="200"><?= $value->deks?></td>
                      <td width="200">
                        <a href="<?= base_url('Admin/Ubahfhotel').'?id='.$value->id;?>" class="btn btn-success" >Ubah</a>
                       <!-- Button trigger modal -->
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal<?= $value->id?>">
                          Hapus
                        </button>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="<?= base_url('Admin/hapusfhotelat ').'?id='.$value->id;?>" type="button" class="btn btn-primary">Yakin</a>
                              </div>
                            </div>
                          </div>
                        </div>
